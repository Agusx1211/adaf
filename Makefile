.PHONY: build install test race clean lint fmt web web-install web-watch e2e-install e2e e2e-clean record-vibe-fixture record-gemini-fixture record-opencode-fixture record-codex-fixture
